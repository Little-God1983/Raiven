...
public sealed class RaivenConfig
{
    ...
    public bool SuppressDuplicateQuestionPrompts { get; set; } = true; // drop Claude Code's "permission to use AskUserQuestion" notification, already announced from the PreToolUse hook
